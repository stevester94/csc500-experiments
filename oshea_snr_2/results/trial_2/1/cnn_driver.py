...
# DS_PATH = "/mnt/wd500GB/CSC500/csc500-super-repo/csc500-dataset-utils/oshea_original/dataset/RML2016.10a_dict.dat"
source_ds = OShea_RML2016_DS(snrs_to_get=source_domains)
target_ds = OShea_RML2016_DS(snrs_to_get=target_domains)
...
transform_lambda = lambda ex: (ex[0], ex[1]) # Strip the tuple to just (x,y)
...
transform_lambda = lambda ex: (ex[0], ex[1], ex[2]) # Strip the tuple to just (x,y,u)
