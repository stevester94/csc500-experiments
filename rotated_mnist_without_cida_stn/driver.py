#! /usr/bin/env python3
from cida_images_stn_cnn import CIDA_Images_CNN_Model
...
if len(sys.argv) > 1 and sys.argv[1] == "-":
    ...
    fake_args["patience"] = 20
    fake_args["seed"] = 1337
    fake_args["device"] = "cuda"
    fake_args["num_examples_per_domain"] = 10000
...
num_examples_per_domain = parameters["num_examples_per_domain"]
    ...
    [ 
        {
            ...
            "num_examples_in_domain":num_examples_per_domain,
        },
        {
            "domain_index":1/12,
...
target_ds = CIDA_MNIST_DS(
    ...
    [
        ...
        {
            "domain_index":5/12,
            "min_rotation_degrees":51,
            "max_rotation_degrees":60,
            "num_examples_in_domain":num_examples_per_domain,
        },
        {
            "domain_index":6/12,
            "min_rotation_degrees":61,
            "max_rotation_degrees":70,
            "num_examples_in_domain":num_examples_per_domain,
        },
        {
            "domain_index":7/12,
            "min_rotation_degrees": 71,
            "max_rotation_degrees":80,
            "num_examples_in_domain":num_examples_per_domain,
        },
        {
            "domain_index":8/12,
            "min_rotation_degrees": 81,
        ...
        },
        {
            ...
            "max_rotation_degrees":100,
            "num_examples_in_domain":num_examples_per_domain,
        },
                {
            "domain_index":10/12,
            "min_rotation_degrees": 101,
            "max_rotation_degrees":110,
            "num_examples_in_domain":num_examples_per_domain,
        },
        {
            "domain_index":11/12,
            "min_rotation_degrees": 111,
            "max_rotation_degrees":120,
            "num_examples_in_domain":num_examples_per_domain,
        },
        {
            "domain_index":12/12,
            "min_rotation_degrees": 121,
