...
base_parameters["experiment_name"] = "CNN SampsPerSymbol Train One Test Several Trial 3"
...
conductor = Conductor(
    TRIALS_BASE_PATH=os.path.realpath(os.path.join("./results/", "SampsPerSymbolTrainOneTestSeveral", "trial_3")),
