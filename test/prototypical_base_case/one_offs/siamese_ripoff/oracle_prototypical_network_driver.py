...
if len(sys.argv) > 1 and sys.argv[1] == "-":
    ...
    base_parameters["x_net"] =     [# droupout, groups, 512 out
        {"class": "Conv1d", "kargs": { "in_channels":2, "out_channels":32, "kernel_size":3, "stride":1, "padding":0, },},
        {"class": "ReLU", "kargs": {"inplace": True}},

        {"class": "Conv1d", "kargs": { "in_channels":32, "out_channels":64, "kernel_size":3, "stride":1, "padding":0, },},
        {"class": "ReLU", "kargs": {"inplace": True}},
        {"class": "MaxPool2d", "kargs": {"kernel_size": 2, "stride":2}},

        {"class": "Conv1d", "kargs": { "in_channels":32, "out_channels":128, "kernel_size":3, "stride":1, "padding":0, },},
        {"class": "ReLU", "kargs": {"inplace": True}},
        {"class": "MaxPool2d", "kargs": {"kernel_size": 2, "stride":2}},


        {"class": "Conv1d", "kargs": { "in_channels":64, "out_channels":64, "kernel_size":3, "stride":1, "padding":0, },},
        {"class": "ReLU", "kargs": {"inplace": True}},
        {"class": "MaxPool2d", "kargs": {"kernel_size": 2, "stride":2}},

        {"class": "Conv1d", "kargs": { "in_channels":32, "out_channels":32, "kernel_size":3, "stride":1, "padding":0, },},
        {"class": "ReLU", "kargs": {"inplace": True}},
        {"class": "MaxPool2d", "kargs": {"kernel_size": 2, "stride":2}},

        {"class": "Flatten", "kargs": {}},

        {"class": "Linear", "kargs": {"in_features": 96, "out_features": 512}},
    ]
...
# print("Shape output:", x_net(torch.ones(1,2,128)).shape)
# sys.exit(1)
